...
let me = _stringPathCleaner('public/05_archive/lifetime-of-wishing-100-birthdays')
console.log(me);
...
const _arrayPathCleaner = (files) =>{
  ...
  const regex = /\/\d*_\B/gm; // get digits at the front of a string upto and including an underscore
...
const _copyMediaClean = ({srcPath, outputPath}) => {
  ...
  // cleanedFiles = _pathCleaner(files)

  // fse.copySync(`${srcPath}/pages`, `${outputPath}`);
