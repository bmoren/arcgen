...
const cli = meow(
  chalk`
    {underline {green Initialize a new site in the pwd:}}
    ...
    {underline {green Generate srcset optimized images:}}
      ...
      {magenta options:}
        ...
        {cyan -q, --quality <integer>}            Set the quality of the image exports; 1-100. Image type dependent. (default: 80)

    {underline {green Batch delete srcset folders:}}
 
        {blue $ arcgen clean [options]}

        {magenta options:}
        {cyan -d, --directory <file-path>}        subdirectory to search for and delete. (default: /srcset)
